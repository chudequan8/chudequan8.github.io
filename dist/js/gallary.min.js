function addPhoto(t,a){for(var o=t.wrap,e="",s="",n=0;n<a.length;n++){var r='<div class="photo photo-front" id="photo_'+n+'"><div class="photo-wrap"><div class="side side-front"><p class="image"><img src="dist/img/'+a[n].img+'" alt="'+a[n].title+'"></p><p class="caption">'+a[n].title+'</p></div><div class="side side-back"><p class="desc"><span>'+a[n].desc+"</span></p></div></div></div>",i='<span class="dot" id="dot_'+n+'"></span>';e+=r,s+=i}s='<div class="nav">'+s+"</div>",o.innerHTML=e+s,o.style.display="block",t.sort(random([0,a.length])),t.turn(),[].forEach.call(document.querySelectorAll(".desc"),function(t){Ps.initialize(t)})}function random(t){var a=Math.max(t[0],t[1]),o=Math.min(t[0],t[1]),e=a-o;return Math.floor(Math.random()*e+o)}function getIndex(t,a){for(var o=0;o<t.length;o++)if(t[o]===a)return o}function turnBack(t,a,o,e){var s=t.className;s.indexOf("photo-center")!=-1?s.indexOf("photo-front")!=-1?(t.className=s.replace(/photo-front/,"photo-back"),a.className+=" back"):s.indexOf("photo-back")!=-1?(t.className=s.replace(/photo-back/,"photo-front"),a.className=a.className.replace(/\s*back\s*/,"")):alert("请为photo添加正面或反面的样式"):e.sort(o)}function randomSort(t,a){for(var o=a.splice(0,Math.floor(a.length/2)),e=a,s=o[0].offsetWidth,n=o[0].offsetHeight,r=t.offsetWidth,i=t.offsetHeight,l=0,c=o.length;l<c;l++)o[l].style.top=random([-n/2,i-n/2])+"px",o[l].style.left=random([-s/2,r/2-s])+"px",o[l].style.margin=0,o[l].style.transform="rotate("+random([-150,150])+"deg)";for(var l=0,c=e.length;l<c;l++)e[l].style.top=random([-n/2,i-n/2])+"px",e[l].style.left=random([r/2,r-s/2])+"px",e[l].style.margin=0,e[l].style.transform="rotate("+random([-150,150])+"deg)"}function annularSort(t,a){for(var o=a.splice(0,Math.floor(a.length/2)),e=a,s=t.offsetWidth,n=t.offsetHeight,r=Math.min(s,n)/2,i=0,l=o.length;i<l;i++)o[i].style.transform="rotate("+random([105,270])+"deg) translate("+r+"px)";for(var i=0,l=e.length;i<l;i++)e[i].style.transform="rotate("+random([-90,75])+"deg) translate("+r+"px)"}var Gallary=function(){window.Gallary=this};Gallary.prototype.turn=function(){for(var t=(this.wrap,this.photoList),a=this.dotList,o=this,e=0;e<t.length;e++)t[e].onclick=function(t){return function(e){turnBack(this,a[t],t,o),e.preventDefault(),e.stopPropagation()}}(e),a[e].onclick=function(a){return function(e){turnBack(t[a],this,a,o),e.preventDefault(),e.stopPropagation()}}(e)},Gallary.prototype.init=function(t){this.options=t?t:"random",this.wrap=document.getElementById("wrap");var a=new XMLHttpRequest;a.open("GET","../dist/data/data.json"),a.send(),a.onreadystatechange=function(){if(4===a.readyState)if(200===a.status){var t=JSON.parse(a.responseText);addPhoto(this,t)}else alert("发生错误"+a.status)}.bind(this);var o=null;window.onresize=function(){null==o&&(o=setTimeout(function(){this.sort(random([0,this.photoList.length])),o=null}.bind(this),2e3))}.bind(this)},Gallary.prototype.sort=function(t){this.photoList=document.getElementsByClassName("photo"),this.dotList=document.getElementsByClassName("dot");for(var a=this.wrap,o=this.photoList,e=this.dotList,s=o[t],n=[],r=this.options,i=0;i<o.length;i++){var l=o[i];l.removeAttribute("style"),l.className=l.className.replace("photo-back","photo-front"),l.className=l.className.replace(/\s*photo-center\s*/,""),n.push(l),e[i].className="dot"}s.className+=" photo-center",e[t].className+=" current fa fa-undo",n.splice(t,1),"random"===r?randomSort(a,n):"annular"===r?annularSort(a,n):alert("没有这种排序方式，请重新指定")};
